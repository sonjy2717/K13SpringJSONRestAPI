...
$(function() {
	...
	$('#btnBoard').click(function() {
		...
		//리스트를 요청 했을때 loading이미지를 보임처리한다.
		$('#loading').show();
...
function sucCallBack(resData) {
	...
	//요청이 완료되어 콜백되면 loading이미지를 숨김처리 한다.
	$('#loading').hide(500);
}
//실패했을때의 콜백 함수
...
<div class="container">
	...
	<div>
		<select id="nowPage">
			...
			<option value="6">6page</option>
			<option value="7">7page</option>
			<option value="8">8page</option>
			<option value="9">9page</option>
			<option value="10">10page</option>
			<option value="11">11page</option>
			<option value="12">12page</option>
		</select>
